...
- 문서는 세 종류로 나눠 다룬다.
  ...
  - **기록**: 한 번 겪은 일을 그대로 남기는 문서 (`ops/opendid-verifier-연동.md`의 구축 로그, `qa/web-qa-sheet.xlsx`의 판정). 최신을 맨 위에 쓰고, 오래되거나 끝난 항목은 자유롭게 압축·정리한다. 작업 경과와 결정 근거는 커밋 메시지에 남기므로 별도의 로그 문서는 두지 않는다.
